...
class menu(models.Model):
    ...
    store_id = models.ForeignKey(Store, related_name='+', on_delete=models.CASCADE, blank=True, null=True)
    updt_dt = models.DateTimeField(db_column='updt_dt', auto_now=True)
    insrt_dt = models.DateTimeField(db_column='insrt_dt', auto_now_add=True)
    usage_fg = models.CharField(db_column='usage_fg', max_length=1, blank=True, null=True, default='Y')
...
class Review(models.Model):
    ...
    user_id = models.ForeignKey(User, related_name='+',  on_delete=models.CASCADE, blank=True, null=True)
    store_id = models.ForeignKey(Store,  related_name='+', on_delete=models.CASCADE, blank=True, null=True)
...
class Review_Img(models.Model):
    ...
    review_id = models.ForeignKey(Review, related_name='+',  on_delete=models.CASCADE)
    # 등록, 수정 컬럼 + 데이터 보존 Flag 컬럼
    updt_dt = models.DateTimeField(db_column='updt_dt', auto_now=True)
    insrt_dt = models.DateTimeField(db_column='insrt_dt', auto_now_add=True)
    usage_fg = models.CharField(db_column='usage_fg', max_length=1, blank=True, null=True, default='Y')
